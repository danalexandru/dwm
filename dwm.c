...
enum { SchemeNorm, SchemeSel, SchemeStatus, SchemeTagsSel, SchemeTagsNorm, SchemeInfoSel, SchemeInfoNorm, SchemeHid }; /* color schemes */
...
void
runAutostart(void) {
	system("cd ~/.config/scripts/dwm; ./autostart_blocking.sh");
